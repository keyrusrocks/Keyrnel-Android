package com.keyrus.keyrnel.widget.layout
...
/**
 * Class : AspectRatioRelativeLayout
 * Information : RelativeLayout with Fix Aspect Ratio
 *
 * Created by Paul Mougin on 21/12/2015.
 */
class AspectRatioRelativeLayout : android.widget.RelativeLayout {
