package com.keyrus.keyrnel.widget.spinner
...
/**
 * Created by Paul Mougin on 28/09/15.
 */
 ...
 * @param context
 */
open class SpinnerAdapterWithHint(private var adapter: SpinnerAdapter, private var nothingSelectedLayout: Int, private var nothingSelectedDropdownLayout: Int, protected var context: Context) : SpinnerAdapter, ListAdapter {
